...
import { validateStructure, ValidateStructureInputSchema, } from "./tools/validate-structure.js";
import { analyzePaths, AnalyzePathsInputSchema, } from "./tools/analyze-paths.js";
import { analyzeDialogue, AnalyzeDialogueInputSchema, } from "./tools/analyze-dialogue.js";
import { analyzeBranchDistribution, AnalyzeBranchDistributionInputSchema, } from "./tools/analyze-branch-distribution.js";
import { checkConstraints, CheckConstraintsInputSchema, } from "./tools/check-constraints.js";
import { scoreNonLinearity, ScoreNonLinearityInputSchema, } from "./tools/score-nonlinearity.js";
// 统一响应封装
const ok = (data) => ({
    content: [
        {
